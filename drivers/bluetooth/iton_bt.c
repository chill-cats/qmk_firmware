...
void iton_bt_control(uint8_t cmd, uint8_t param) { iton_bt_write2(control, cmd, param); }

void iton_bt_mode_usb(void) { iton_bt_control(control_usb, mode_usb); }

void iton_bt_mode_bt(void) { iton_bt_control(control_bt, mode_bt); }

void iton_bt_reset_pairing(void) { iton_bt_control(control_bt, reset_pairing); }

void iton_bt_enter_pairing(void) { iton_bt_control(control_bt, enter_pairing); }
...
void iton_bt_os_mac(void) { iton_bt_control(control_bt, os_mac); }

void iton_bt_os_win(void) { iton_bt_control(control_bt, os_win); }
 ...
 */
void iton_bt_set_pins(uint8_t cfg) { iton_bt_control(control_pins, cfg); }
...
void iton_bt_send_consumer(uint16_t data) { iton_bt_write2(media_report, (uint8_t)(data >> 8), (uint8_t)(data & 0x00ff)); }
