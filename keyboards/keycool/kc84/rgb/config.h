...
#define MANUFACTURER Keycool
#define PRODUCT K84 RGB
...
#define MATRIX_COL_PINS \
    { A8, A9, A10, A11, A12, A13, A14, A15, B0, B1, B2, B3, B4, B5, B6, B7 }
...
#define LED_MATRIX_ROW_PINS \
    { C3, C1, D4, C6, C5, C4, C9, C8, C7, C12, C11, C10, B13, C14, C13, B14, B15, D3 }
